<?php return array (
    ...
    'wizard' => array(
        'title' => 'Required Configuration Setup',
        'subtitle' => 'Some configurations required for application to work',
        'complete_config_setup' => 'Kindly finish configuration setup first!',
        'hide_button' => 'Hide this wizard',
        'skip_button' => 'Skip this step',
        'next_button' => 'Next',
        'back_button' => 'Back',
        'finish_button' => 'Finish',
        'basic_configurations' => 'Lets Start With Some Basic Configurations',
        'app_name' => 'App Name',
        'app_desc' => 'App Description',
        'system_configurations' => 'Update These System Related Configurations',
        'mail_configurations' => 'These Mail Related Configurations Are Required To Send Emails',
        'pusher_configurations' => 'Pusher Is Required For Chat And Notification',
        'signal_server_configurations' => 'Signaling Server is Required For Live Meeting',
        'ice_server_configurations' => 'ICE Server is Required For Live Meeting',
        'setup_completed' => 'Required Configuration Setup Completed!',
    ),
    'product' => array(
